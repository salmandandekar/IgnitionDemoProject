# -*- coding: utf-8 -*-
"""Repository port definition for the Workcenter context."""
from __future__ import absolute_import


class WorkcenterRepository(object):
    """Port describing persistence operations for Workcenter aggregates."""
